...
// Like putFile, but for already-base64-encoded binary data (e.g. an
// uploaded image) rather than a UTF-8 text file — skips the text encoding
// step so binary bytes aren't corrupted.
