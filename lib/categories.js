...
export const CATEGORY_LINKS = {
  ...
  Newsletter: { href: "/chai-charts", label: "Chai & Charts" },
  ...
  // Growth" monthly report pattern. Deliberately separate from Chai &
  // Charts (weekly, paused) rather than merged into it.
