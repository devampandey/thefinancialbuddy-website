...
export const CATEGORY_LINKS = {
  ...
  // Manually-authored long-form pieces (history, economics, the AI
  // landscape, and similar) — deliberately not part of the automated
  // scheduled-draft pipeline; written and published by a human on a
  // roughly weekly, 1-2-article cadence rather than a fixed schedule.
