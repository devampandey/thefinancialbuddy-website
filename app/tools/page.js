...
export default function ToolsPage() {
  return (
    <div className="mx-auto max-w-6xl px-6 py-16">
      <h1 className="text-3xl font-bold text-navy dark:text-white">Free Financial Tools</h1>
      ...
      <div className="mt-10 grid gap-6 sm:grid-cols-2">
        {tools.map((tool) => (
          ...
          >
            <h2 className="text-lg font-semibold text-navy dark:text-white">{tool.title}</h2>
